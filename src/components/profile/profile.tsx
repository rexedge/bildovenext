  ...
  return (
    <div className=" mt-20 mx-auto p-6 bg-white rounded-lg shadow-md flex flex-col items-center space-y-4">
      <Avatar className="w-24 h-24 shadow-xl border border-gray-300">
        <AvatarImage alt="Jose Graxirena" src="/emily.jpg" />
      </Avatar>
      <h1 className="text-2xl font-semibold">Jose Graxirena</h1>
      <p className="text-sm text-gray-500">Field Underwriter & Broker</p>
      <p className="text-sm text-gray-500">License #18599905</p>
      <div className="flex space-x-4">
        <Button className="bg-[#e0e0e0] text-black" variant="ghost">
          <Link href='/#'><Icons.PhoneIcon className="text-black" /></Link>
          SMS
        </Button>
        <Button className="bg-[#e0e0e0] text-black" variant="ghost">
          <Link href='/#'> <Icons.MailboxIcon className="text-black" /></Link>

          Email
        </Button>
        <Button className="bg-[#e0e0e0] text-black" variant="ghost">
          <Link href='/#'><Icons.HomeIcon className="text-black" /></Link>
