...
const Footer = () => {
     ...
     if (pathname?.startsWith("/profile") || pathname?.startsWith("/event")) {
          return null;
     }
     return (
          <footer className="relative overflow-hidden border-t border-border/60 bg-foreground text-background">
               ...
               <div className="relative mx-auto max-w-[1400px] px-6 pb-10 pt-24 lg:px-10">
                    ...
                    <div className="flex flex-col gap-10 lg:flex-row lg:items-end lg:justify-between">
                         <div className="max-w-3xl">
                              ...
                              <p className="mt-6 max-w-xl text-base leading-relaxed text-background/65">
                                   Sit down with a licensed advisor — no cost,
                                   no pressure. We&apos;ll map the moves that
                                   protect today and compound tomorrow.
                              </p>
                         </div>
                    ...
                    <div className="mt-14 grid gap-14 lg:grid-cols-12">
                         ...
                         <div className="space-y-3 lg:col-span-5">
                              ...
                              <p className="max-w-md text-sm leading-relaxed text-background/65">
                                   {COMPANY_PROFILE.tagline}. We help
                                   individuals and families protect their
                                   income, grow wealth, and build lasting
                                   legacies with personalized financial
                                   guidance.
                              </p>
                         ...
                         <div className="space-y-5 lg:col-span-4">
                              ...
                              <p className="text-sm text-background/65">
                                   Quarterly notes on protection, growth, and
                                   legacy planning.
                              </p>
                              <form
                    ...
                    >
                         Bildove
                         <span className="italic text-primary/15">.</span>
                    </div>
