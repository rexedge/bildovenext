			...
			<div className='container mx-auto px-4 py-10 text-center'>
				...
				<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
					<div className='flex flex-col items-center'>
						<DocumentTextIcon className='text-purple-500 h-20 w-20 mb-5' />
						<div>
					...
					<div className='flex flex-col items-center'>
						<CurrencyDollarIcon className='text-purple-500 h-20 w-20 mb-5' />
						<div>
							<h3 className='text-xl font-bold mb-2'>
								Holistic Approach
							</h3>
					...
					<div className='flex flex-col items-center'>
						<AcademicCapIcon className='text-purple-500 h-20 w-20 mb-5' />
						<div>
							<h3 className='text-xl font-bold mb-2'>
								Continuous Learning
							</h3>
