...
const Values: React.FC = () => {
	return (
		<section className='min-h-full bg-purple-100 dark:bg-purple-800'>
			<div className='container mx-auto px-4 py-10 text-center'>
				<h2 className='text-4xl font-bold mb-16'>Our Values</h2>
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
					<div className='flex flex-col items-center'>
						<UserGroupIcon className='h-20 w-20 mb-2 text-purple-600' />
					...
					<div className='flex flex-col items-center'>
						<CurrencyDollarIcon className='h-20 w-20 mb-2 text-purple-600' />
						<h3 className='text-xl font-bold mb-2'>
					...
					<div className='flex flex-col items-center'>
						<LightBulbIcon className='h-20 w-20 mb-2 text-purple-600' />
						<h3 className='text-xl font-bold mb-2'>
