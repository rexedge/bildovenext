...
export const COMPANY_PROFILE = {
     ...
     address: "3300 Hamilton Mill Rd, Ate 102 #426 Buford,GA 30519",
     phone: "+1(803)-250-1030", //18032501030
     email: "bildovefinancial@gmail.com",
     calendly: "https://calendly.com/bildovefinancial/one-one-one",
     description:
          "Discover comprehensive financial solutions with Bildove Financial Services. As a licensed financial agency, we offer expert guidance in investment management, retirement planning, and wealth preservation to help you achieve your financial goals. Trust Bildove for personalized financial advice and strategic planning.",
};
...
export const INTRO_TEXT = {
     image: "/pocket.png",
     description: `${COMPANY_PROFILE.name} Solutions has seasoned licensed financial professionals who provide financial literacy to clients at nocost. We are licensed in all 50 states and the U.S. territories.

`,
};

export const WELCOME_TEXT = `Welcome to ${COMPANY_PROFILE.name} Solutions, your
...
export const TESTIMONIES = [
     ...
     },
     {
          ...
          title: `Emily Bricks`,
          image: `/emily.jpg`,
          description: `"${COMPANY_PROFILE.name} Solutions provided excellent customer service by understanding my financial goals and tailoring their services accordingly. Their team was always available to answer my questions and provide guidance."`,
     },
];
